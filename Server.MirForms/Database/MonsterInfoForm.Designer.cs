namespace Server
{
    partial class MonsterInfoForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.DropBuilderButton.Text = "掉落构建器";
