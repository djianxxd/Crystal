public class GameLanguage
{
    ...
    public static string PetMode_Both = "[宠物: 攻击并移动]",
                         ...
                         AttackMode_RedBrown = "[模式: 红名/褐名]",
                         AttackMode_All = "[模式: 攻击所有人]",

                         LogOutTip = "你确定要退出传奇世界吗？",
                         ExitTip = "你确定要退出传奇世界吗？",
                         DiedTip = "你已经死亡，是否要在城镇复活？",
                         DropTip = "你确定要丢弃 {0} 吗？",
                         ...
                         HeroSkills = "英雄技能 ({0})",
                         HeroExperienceGained = "英雄获得经验值 {0}",
                         ...
                         MaxCombine = "最大堆叠数量 : {0}{1}按住Shift + 左键点击拆分堆叠",
                         Count = " 数量 {0}",
                         ExtraSlots8 = "你确定要花费1,000,000金币购买8个额外物品栏空格吗？" +
                         "下次购买可解锁4个额外空格，最多可达40个空格。",
                         ExtraSlots4 = "你确定要花费 {0:###,###} 金币解锁4个额外空格吗？",
                         ...
                         ExtraStorage = "你是否愿意花费1,000,000金币租用10天的额外仓库空间？",
                         ExtendYourRentalPeriod = "你是否愿意花费1,000,000金币将租用期延长10天？",

                         CannotLeaveGame = "{0} 秒内无法离开游戏",
                         SelectKey = "选择按键: {0}",

                         WeaponSpiritFire = "你的武器被火焰之灵缠绕。",
                         SpiritsFireDisappeared = "火焰之灵消失了。",
                         WeddingRing = "结婚戒指",
                         ...
                         NoCreatures = "你没有任何宠物。",
                         NoMount = "你没有坐骑。",
                         NoFishingRod = "你没有持有钓鱼竿。",
                         AttemptingConnect = "正在尝试连接服务器。{0}尝试次数:{1}",

                         CreatingCharactersDisabled = "当前已禁用创建新角色。",
                         InvalidCharacterName = "你的角色名称不可接受。",
                         NoClass = "你选择的职业不存在。请联系游戏管理员获取帮助。",
                         ToManyCharacters = "你最多只能创建 {0} 个角色。",
                         CharacterNameExists = "该角色名称已存在。",
                         WarriorsDes = "战士是力量和生命力极强的职业。他们在战斗中不易死亡，并且能够使用" +
                                        "各种重型武器和盔甲。因此，战士偏爱基于近战物理伤害的攻击。他们在远程" +
                                        "攻击方面较弱，但专门为战士开发的各种装备弥补了他们在远程战斗中的弱点。",
                         WizardDes = "法师是力量和耐力较低的职业，但拥有使用强大法术的能力。他们的攻击性法术非常有效，但" +
                                        "由于施法需要时间，他们很可能在施法时暴露自己，遭受敌人的攻击。因此，身体虚弱的法师" +
                                        "必须从安全距离攻击敌人。",
                         TaoistDes = "道士在天文学、医学等方面有着良好的修养，不仅仅是武功。他们不直接与敌人交战，而是" +
                                        "专注于辅助盟友。道士可以召唤强大的生物，并且对魔法有很高的抵抗力，是一个" +
                                        "攻防能力平衡的职业。",
                         AssassinDes = "刺客是秘密组织的成员，他们的历史相对不为人知。他们能够隐身并在不被他人察觉的情况下进行攻击，" +
                                        "这使他们天生擅长快速击杀。由于生命力和力量较弱，他们必须避免与多个敌人战斗。",
                         ArcherDes = "弓箭手是精准和力量兼备的职业，他们使用强大的弓术技能从远处造成惊人的伤害。与法师相似，" +
                                        "他们依靠敏锐的直觉躲避来袭的攻击，因为他们在正面攻击面前往往不堪一击。然而，他们的" +
                                        "身体力量和致命的瞄准能力让任何被击中的人都感到恐惧。",
                         DateSent = "发送日期 : {0}",
                         Send = "发送",
                         Reply = "回复",
                         Read = "阅读",
                         Delete = "删除",
                         BlockList = "黑名单",
                         EnterMailToName = "请输入你要邮寄的人的名字。",
                         AddFriend = "添加",
                         RemoveFriend = "移除",
                         FriendMemo = "备注",
                         FriendMail = "邮件",
                         FriendWhisper = "私聊",
                         FriendEnterAddName = "请输入你想要添加的人的名字。",
                         FriendEnterBlockName = "请输入你想要屏蔽的人的名字。",
                         AddMentor = "添加师傅",
                         RemoveMentorMentee = "解除师徒关系",
                         MentorRequests = "允许/拒绝师徒请求",
                         MentorEnterName = "请输入你想要成为师傅的人的名字。",
                         RestedBuff = "休息中{0}经验值获取率提升 {1}%{2}",
                         ...
                         ItemTypeFish = "鱼",
                         ItemTypeQuest = "任务物品",
                         ItemTypeAwakening = "觉醒物品",
                         ItemTypePets = "宠物",
                         ItemTypeTransform = "变形道具",
                         ItemTypeDeco = "装饰物",
                         ItemTypeMonsterSpawn = "召唤蛋",
                         ...
                         ItemGradeHeroic = "英雄",
                         NoAccountID = "该账号不存在。",
                         IncorrectPasswordAccountID = "账号或密码错误。",
                         GroupSwitch = "允许/拒绝组队请求",
                         GroupAdd = "添加",
                         GroupRemove = "移除",
                         GroupAddEnterName = "请输入你想要添加的人的名字。",
                         GroupRemoveEnterName = "请输入你想要移除的人的名字。",
                         TooHeavyToHold = "物品太重，无法携带。",
                         SwitchMarriage = "允许/屏蔽结婚",
                         RequestMarriage = "求婚",
                         RequestDivorce = "离婚",
                         MailLover = "给情侣发邮件",
                         WhisperLover = "私聊情侣";
    ...
    public static string Welcome = "欢迎来到 {0} 服务器。",
                         ...
                         WeaponLuck = "你的武器蕴含幸运之力。",
                         WeaponCurse = "你的武器被诅咒缠绕。",
                         WeaponNoEffect = "没有效果。",
                         InventoryIncreased = "物品栏空间已增加。",
                         FaceToTrade = "交易时你必须面对对方。",
                         NoTownTeleport = "此处无法使用回城卷轴",
                         CanNotRandom = "此处无法使用随机传送卷",
                         CanNotDungeon = "此处无法使用地牢逃脱卷轴",
                         CannotResurrection = "活着的时候无法使用复活卷轴",
                         CanNotDrop = "在此地图上无法丢弃物品",
                         NewMail = "有新邮件到达。",
                         CouldNotFindPlayer = "找不到玩家 {0}",
                         BeenPoisoned = "你已中毒",
                         AllowingMentorRequests = "你现在允许师徒请求。",
                         BlockingMentorRequests = "你现在拒绝师徒请求。";

    //通用
    public static string LowLevel = "你的等级不够高。",
                         LowGold = "金币不足。",
                         LevelUp = "恭喜！你升级了。你的生命值和魔法值已恢复。",
                         LowDC = "你的攻击力不足。",
                         LowMC = "你的魔法力不足。",
                         LowSC = "你的道力不足。",
                         GameName = "传奇世界 2",
