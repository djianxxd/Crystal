    ...
    public sealed class LoginScene : MirScene
    {
        ...
        public LoginScene()
        {
            ...
            Version = new MirLabel
            {
                ...
                Parent = _background,
                Text = string.Format("建造: {0}.{1}.{2}", Globals.ProductCodename, Settings.UseTestConfig ? "Debug" : "Release", Application.ProductVersion),
            };
            ...
            _connectBox = new MirMessageBox("尝试连接到服务器.", MirMessageBoxButtons.Cancel);
        ...
        private void ClientVersion(S.ClientVersion p)
        {
            ...
            {
                case 0:
                    MirMessageBox.Show("版本错误，请更新您的游戏。\r\n游戏即将关闭", true);
        ...
        private void NewAccount(S.NewAccount p)
        {
            ...
            {
                case 0:
                    MirMessageBox.Show("账户创建目前已禁用.");
                    _account.Dispose();
                    break;
                case 1:
                    MirMessageBox.Show("您的账户ID不可接受.");
                ...
                case 2:
                    ...
                    break;
                case 3:
                    MirMessageBox.Show("您的电子邮件地址不被接受.");
                ...
                case 4:
                    ...
                    break;
                case 5:
                    MirMessageBox.Show("您的保密问题不可接受.");
                    _account.QuestionTextBox.SetFocus();
                    break;
                case 6:
                    MirMessageBox.Show("你的密保答案不可接受.");
                    _account.AnswerTextBox.SetFocus();
                    break;
                case 7:
                    MirMessageBox.Show("账户已存在.");
                    _account.AccountIDTextBox.Text = string.Empty;
                    _account.AccountIDTextBox.SetFocus();
                    break;
                case 8:
                    MirMessageBox.Show("您的账户创建成功。.");
                    _account.Dispose();
                    break;
            }
        }
        ...
        private void Login(S.Login p)
        {
            ...
            switch (p.Result)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    MirMessageBox.Show("登录前必须更改该账户的密码.");                    
        ...
        private void Login(S.LoginBanned p)
        {
            ...
            TimeSpan d = p.ExpiryDate - CMain.Now;
            MirMessageBox.Show(string.Format("该账号已被封禁。\r\n\r\n原因：{0}\r\n到期日期：{1}\r\n时长：{2:#,##0}小时，{3}分钟，{4}秒", p.Reason,
                                             p.ExpiryDate, Math.Floor(d.TotalHours), d.Minutes, d.Seconds));
        }
        ...
        public sealed class NewAccountDialog : MirImageControl
        {
            ...
            private void PasswordTextBox_GotFocus(object sender, EventArgs e)
            {
                ...
                Description.Text = " 描述：密码。\r\n可接受字符：a-z、A-Z、0-9。\r\n长度：介于之间 " +
                                   Globals.MinPasswordLength + " and " + Globals.MaxPasswordLength + " 角色.";
            }
